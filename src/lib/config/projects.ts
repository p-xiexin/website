...
const ACTIVITIES_EN: Array<ActivityItemType> = [
  ...
  {
    name: 'FreeRTOS Internals Demo',
    description:
      'Interactive demo site illustrating FreeRTOS internals, covering scheduling, context switching, and so on. Content auto-generated by Google AI Studio and human-reviewed.',
    date: '2025-12-16',
    location: 'Wuhan',
    link: 'https://p-xiexin.github.io/freertos_master/',
  },
];
...
const ACTIVITIES_ZH: Array<ActivityItemType> = [
  ...
  {
    name: 'FreeRTOS 交互式动画演示',
    description:
      'FreeRTOS 原理交互式演示网站，覆盖调度、上下文切换与同步。内容为google ai studio自动生成并经人工校对。',
    date: '2025-12-16',
    location: '武汉',
    link: 'https://p-xiexin.github.io/freertos_master/',
  },
